...
-- Cập nhật dữ liệu hãng sản xuất cho các sản phẩm hiện có
UPDATE Products
SET Manufacturer = 'Dell'
WHERE ProductID = 'SP001' OR ProductID = 'SP003';

UPDATE Products
SET Manufacturer = 'HP'
WHERE ProductID = 'SP002';

UPDATE Products
SET Manufacturer = 'Asus'
WHERE ProductID = 'SP004';

UPDATE Products
SET Manufacturer = 'Kingston'
WHERE ProductID = 'SP005';

UPDATE Products
SET Manufacturer = 'Samsung'
WHERE ProductID = 'SP006';

UPDATE Products
SET Manufacturer = 'Logitech'
WHERE ProductID = 'SP007';

UPDATE Products
SET Manufacturer = 'Corsair'
WHERE ProductID = 'SP008';
