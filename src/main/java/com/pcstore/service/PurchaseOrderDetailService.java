...
import com.pcstore.repository.iPurchaseOrderDetailRepository;
...
public class PurchaseOrderDetailService {
    private final iPurchaseOrderDetailRepository purchaseOrderDetailRepository;
     ...
     */
    public boolean deletePurchaseOrderDetail(Long purchaseOrderDetailId) {
     ...
     */
    public Optional<PurchaseOrderDetail> findPurchaseOrderDetailById(Long purchaseOrderDetailId) {
     ...
     */
    public boolean purchaseOrderDetailExists(Long purchaseOrderDetailId) {
     ...
     * @return Tổng giá trị
     */
    public double calculatePurchaseOrderTotal(String purchaseOrderId) {
