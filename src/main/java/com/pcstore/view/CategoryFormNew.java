...
public class CategoryFormNew extends javax.swing.JPanel {
   ...
   // connection là kết nối DB
    ...
    public CategoryFormNew() {
        ...
        txtCategoryCode.setBackground(new java.awt.Color(220, 220, 220)); // Mã danh mục xám nhạt
    ...
    private void initComponents() {
        ...
        pnTitile.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 20, 25));
        ...
        btnRefreshCategory.setkBackGroundColor(new java.awt.Color(255, 255, 255));
