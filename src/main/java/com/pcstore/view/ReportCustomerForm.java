...
import com.pcstore.controller.ReportCustomerController;
 ...
 * @author DUC ANH
 */
public class ReportCustomerForm extends javax.swing.JPanel {

    private final ReportCustomerController controller;
    ...
    private javax.swing.JLabel lbTotalCustomers;
    private javax.swing.JLabel lbTotalRevenue;
    private javax.swing.JLabel lbAverageOrderValue;
    private javax.swing.JLabel lbTopCustomer;
    private javax.swing.JLabel lbReturnRate;
    ...
    private javax.swing.JTable tableCustomerRevenue;
    private javax.swing.JTextField txtFromDate;
    private javax.swing.JLabel txtTotalCustomers;
    private javax.swing.JLabel txtAverageOrderValue;
    private javax.swing.JLabel txtTopCustomer;
    private javax.swing.JLabel txtReturnRate;
    private javax.swing.JTextField txtToDate;
    // End of variables declaration//GEN-END:variables

    /**
     * Creates new form ReportCustomerForm
     */
    public ReportCustomerForm() {
        ...
        this.controller = ReportCustomerController.getInstance(this);
    }
    ...
    private void initComponents() {
        ...
        lbTotalCustomers = new javax.swing.JLabel();
        ...
        lbTopCustomer = new javax.swing.JLabel();
        txtTopCustomer = new javax.swing.JLabel();
        lbReturnRate = new javax.swing.JLabel();
        txtReturnRate = new javax.swing.JLabel();
        panelTable = new javax.swing.JPanel();
        jScrollPane = new javax.swing.JScrollPane();
        tableCustomerRevenue = new javax.swing.JTable();
        ...
        lbTitle.setText(bundle.getString("lbReportCustomerTitle"));
        ...
        btnFromDate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pcstore/resources/icon/schedule.png")));
        ...
        btnToDate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pcstore/resources/icon/schedule.png")));
        ...
        btnExportReport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pcstore/resources/icon/xls.png")));
        ...
        panelBody.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("borderCustomerReportInfo"),
        ...
        lbTotalCustomers.setFont(new java.awt.Font("Segoe UI", 1, 14));
        lbTotalCustomers.setForeground(new java.awt.Color(0, 69, 196));
        lbTotalCustomers.setText(bundle.getString("lbTotalCustomers"));
        panelContent.add(lbTotalCustomers);

        txtTotalCustomers.setFont(new java.awt.Font("Segoe UI", 1, 14));
        txtTotalCustomers.setForeground(new java.awt.Color(0, 69, 196));
        txtTotalCustomers.setText("...");
        panelContent.add(txtTotalCustomers);
        ...
        lbTopCustomer.setFont(new java.awt.Font("Segoe UI", 1, 14));
        lbTopCustomer.setForeground(new java.awt.Color(0, 69, 196));
        lbTopCustomer.setText(bundle.getString("lbTopCustomer"));
        panelContent.add(lbTopCustomer);

        txtTopCustomer.setFont(new java.awt.Font("Segoe UI", 1, 14));
        txtTopCustomer.setForeground(new java.awt.Color(0, 69, 196));
        txtTopCustomer.setText("...");
        panelContent.add(txtTopCustomer);

        lbReturnRate.setFont(new java.awt.Font("Segoe UI", 1, 14));
        lbReturnRate.setForeground(new java.awt.Color(0, 69, 196));
        lbReturnRate.setText(bundle.getString("lbReturnRate"));
        panelContent.add(lbReturnRate);

        txtReturnRate.setFont(new java.awt.Font("Segoe UI", 1, 14));
        txtReturnRate.setForeground(new java.awt.Color(0, 69, 196));
        txtReturnRate.setText("...");
        panelContent.add(txtReturnRate);
        ...
        tableCustomerRevenue.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][] {
                ...
                new String[] {
                        bundle.getString("tableColumnCustomerID"), bundle.getString("tableColumnCustomerName"), 
                        bundle.getString("tableColumnOrderCount"), bundle.getString("tableColumnTotalAmount"), 
                        bundle.getString("tableColumnDiscount"), bundle.getString("tableColumnRevenue"), 
                        bundle.getString("tableColumnReturnCount"), bundle.getString("tableColumnReturnValue"), 
                        bundle.getString("tableColumnNetRevenue")
                }) {
        ...
        tableCustomerRevenue.getTableHeader().setReorderingAllowed(false);
        jScrollPane.setViewportView(tableCustomerRevenue);
        if (tableCustomerRevenue.getColumnModel().getColumnCount() > 0) {
            tableCustomerRevenue.getColumnModel().getColumn(0).setPreferredWidth(80);
            tableCustomerRevenue.getColumnModel().getColumn(0).setMaxWidth(80);
            tableCustomerRevenue.getColumnModel().getColumn(1).setPreferredWidth(200);
            tableCustomerRevenue.getColumnModel().getColumn(2).setPreferredWidth(100);
            tableCustomerRevenue.getColumnModel().getColumn(2).setMaxWidth(100);
            tableCustomerRevenue.getColumnModel().getColumn(3).setPreferredWidth(120);
            tableCustomerRevenue.getColumnModel().getColumn(4).setPreferredWidth(100);
            tableCustomerRevenue.getColumnModel().getColumn(5).setPreferredWidth(120);
            tableCustomerRevenue.getColumnModel().getColumn(6).setPreferredWidth(100);
            tableCustomerRevenue.getColumnModel().getColumn(6).setMaxWidth(100);
            tableCustomerRevenue.getColumnModel().getColumn(7).setPreferredWidth(120);
            tableCustomerRevenue.getColumnModel().getColumn(8).setPreferredWidth(120);
        }
        ...
        lbTotalRevenue.setText(bundle.getString("lbTotalRevenue"));
    ...
    public javax.swing.JTable getTableCustomerRevenue() {
        return tableCustomerRevenue;
    }
    ...
    public javax.swing.JLabel getTxtTotalCustomers() {
        return txtTotalCustomers;
    }
    ...
    public javax.swing.JLabel getTxtTopCustomer() {
        return txtTopCustomer;
    }

    public javax.swing.JLabel getTxtReturnRate() {
        return txtReturnRate;
    }
}
